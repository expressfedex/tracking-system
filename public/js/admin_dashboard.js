...
const sections = document.querySelectorAll('.content-section'); // This is correctly defined
const navLinks = document.querySelectorAll('.sidebar nav ul li a'); // <-- NEW: Select all sidebar links
const sidebarListItems = document.querySelectorAll('.sidebar nav ul li'); // <-- NEW: Select sidebar list items for active class
